...
> 在线阅读：[PM AI Toolkit](https://xuqiang97.github.io/pm-ai-toolkit/)
...
| 编号 | Tip | 所属工作流 |
|---:|---|---|
| 1 | 会议沟通直接用 AI 听记 | 接需求与资料整理 |
| 2 | 多源文本统一转成 MD | 接需求与资料整理 |
| 3 | 会后纪要升级成决策记录 | 接需求与资料整理 |
| 4 | 把项目资料沉淀到知识库 | 接需求与资料整理 |
| 5 | 让 AI 先反问关键问题 | 需求澄清与范围收敛 |
| 6 | 需求信息完整度评分 | 需求澄清与范围收敛 |
| 7 | MVP 砍范围神器 | 需求澄清与范围收敛 |
| 8 | 一句话需求转完整需求分析框架 | 需求澄清与范围收敛 |
| 9 | 零散需求生成 PRD 草稿 | PRD 与评审准备 |
| 10 | few-shot 让 AI 学你的写作风格 | PRD 与评审准备 |
| 11 | 让 AI 反向 challenge 你的 PRD | PRD 与评审准备 |
| 12 | 自动生成验收用例 | PRD 与评审准备 |
| 13 | 生成需求评审会材料 | PRD 与评审准备 |
| 14 | 用 AI 直接生成 HTML 高保真原型 | HTML 高保真原型 |
| 15 | 用连续追问快速迭代原型 | HTML 高保真原型 |
| 16 | 截图反推需求说明 | HTML 高保真原型 |
| 17 | HTML 原型反向生成多对象文档 | HTML 高保真原型 |
| 18 | 让 AI 模拟用户做可用性预审 | HTML 高保真原型 |
| 19 | Persona Stack 多角色评审 | HTML 高保真原型 |
| 20 | Pre-mortem 失败预演 | HTML 高保真原型 |
| 21 | GitHub Pages 发布 HTML 原型 | HTML 高保真原型 |
| 22 | 需求变更影响分析 | 协同交付与上线 |
| 23 | PRD 转研发任务拆解 | 协同交付与上线 |
| 24 | 生成测试同学最关心的问题 | 协同交付与上线 |
| 25 | 上线公告 / 操作手册 / FAQ 一键生成 | 协同交付与上线 |
| 26 | 向上汇报一页纸 | 协同交付与上线 |
| 27 | 让 AI 分析 CSV / Excel | 数据分析与复盘 |
| 28 | 让 AI 辅助写 SQL | 数据分析与复盘 |
| 29 | 让 AI 从数据里找异常、趋势和机会 | 数据分析与复盘 |
| 30 | 项目复盘自动生成 | 数据分析与复盘 |
