...
> - v7.16 · 约 120 min · 产品经理 AI 应用交流分享
...
> 大家怎么理解 Prompt、LLM、Agent、Skills、RAG？它们分别解决什么问题？
...
| RAG | 先给资料，再让 AI 基于资料回答 | 适合项目资料、调研材料、长文档问答 |

这几个概念不用一开始就掌握很深，先记住一句话：

> **Prompt 负责说清任务，LLM 负责理解和生成，Agent 负责推进任务，Skills 负责沉淀方法，RAG 负责基于资料回答。**
...
> 前面是可以先尝试的基础工作流，下面是后续进阶方向。这里先建立概念，不展开配置教程，也不要求现场掌握。
