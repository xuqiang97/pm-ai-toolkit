...
> 定位：这不是 AI 工具测评，而是一次面向产品经理日常工作的 AI 应用分享。  
...
| 课程定位 | 少讲概念，多看产品经理日常工作中可复用的 AI 工作流 |
| 课程目标 | 听完后能选择 1-2 个真实工作场景尝试用起来 |
...
本次分享不追求覆盖所有 AI 工具，而是演示一条相对实用的工作路径：
...
| 13–24 min | 工作流二：需求澄清与范围收敛 | AI 反问关键问题、完整度评分、MVP 范围收敛 |
| 24–34 min | 工作流三：PRD 与评审准备 | PRD 草稿、反向检查、验收用例、评审材料 |
...
> 现场只围绕主线展开：需求澄清、MVP 收敛、PRD 检查、HTML 原型、变更影响分析和真实案例。其他内容作为课后资料。
...
现场不会逐条讲完 30 个 Tip，而是围绕产品经理从模糊需求到可交付方案的主线，重点讲 7 个 Tip。其他 Tip 作为课后资料，大家可以根据自己的工作场景按需查阅和练习。
...
| 必讲 | Tip 7：MVP 范围收敛 | 帮助一期范围收敛到可落地 |
| 必讲 | Tip 9 / Tip 11：PRD 草稿 + 反向检查 | 快速成稿，再让 AI 补充问题和边界 |
...
| 课后阅读 | Part 5 Prompt 清单、附录 D 30 个 Tip 总览 | 作为课后参考、练习和查阅资料 |

### 课后练习建议

第 1 天：用 Tip 5 练习“AI 反问关键问题”。  
第 2 天：用 Tip 7 练习“MVP 范围收敛”。  
第 3 天：用 Tip 9 / Tip 11 练习“PRD 草稿 + 反向检查”。  
...
> 如果现场时间允许，可以加一个 3 分钟小练习，让大家快速体验。
