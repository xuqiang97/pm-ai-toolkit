...
| 顺序 | 内容 | 时间安排 | 会看到什么 |
|---:|---|---:|---|
| 1 | 开场与痛点共识 | 5-8 min | 先聊大家现在用 AI 的真实场景和卡点 |
| 2 | 接需求与资料整理 | 8-10 min | 为什么要先把上下文整理好 |
| 3 | 需求澄清与范围收敛 | 18-22 min | Tip 5-7，演示反问、评分、MVP 收敛 |
| 4 | PRD 与评审准备 | 18-20 min | Tip 9 / Tip 11，演示 PRD 草稿和反向检查 |
| 5 | HTML 高保真原型 | 25-30 min | Tip 14，演示从需求到可讨论界面 |
| 6 | 协同交付与变更影响 | 12-15 min | Tip 22，演示“小改动”背后的影响面 |
| 7 | 数据分析与复盘 | 8-10 min | Tip 27 / Tip 28，重点看数据口径和结论校验 |
| 8 | 进阶展望与总结 | 10-12 min | 回顾关键方法、进阶方向和课后资料入口 |
...
这一部分按照产品经理日常工作流展开，重点展示高频 Tip 和关键演示。完整 30 个 Tip 索引保留在附录 D，补充 Tip 正文也放在附录 D，方便课后按场景查阅。

> 说明：现场主要围绕重点 Tip 展开；完整 Tip 和补充模板可在附录 D 按场景查阅。
...
本工作流覆盖 Tip 1-4。这里先聚焦“整理上下文”这个原则，完整方法可在附录 D 查阅。

## 工作流二：需求澄清与范围收敛

> 目标：让 AI 帮助 PM 把需求问清楚、想完整、砍到能落地。
> 核心观点：遇到模糊需求时，不急着写方案，先反问、评分、收敛范围。
> 主要内容：Tip 5 → Tip 6 → Tip 7。Tip 8 作为课后资料。
...
本工作流覆盖 Tip 9-13。这里先聚焦 PRD 草稿和反向检查，其他方法可在附录 D 查阅。

## 工作流四：HTML 高保真原型

> 目标：把抽象需求快速变成可点击、可讨论、可评审的界面。
> 核心观点：页面型需求可以先做可点击原型，让讨论从文字想象变成界面共识。
> 主要内容：Tip 14，先把抽象需求变成 HTML 高保真原型。
...
本工作流覆盖 Tip 14-21。这里先聚焦 HTML 原型生成，迭代、预审、发布和反向生成文档的方法可在附录 D 查阅。

## 工作流五：协同交付与上线

> 目标：让 AI 帮助 PM 更好地和研发、测试、业务方协同，而不是只停留在写文档。
> 核心观点：看起来很小的变更，也可以先用 AI 扫一遍页面、接口、权限、数据和测试影响。
> 主要内容：Tip 22，让大家看到一个小变更背后可能影响页面、接口、权限、数据和测试。
...
本工作流覆盖 Tip 22-26。这里先聚焦需求变更影响分析，研发任务、测试关注点、上线公告和向上汇报方法可在附录 D 查阅。
...
> 主要内容：Tip 27 / Tip 28，重点放在数据口径、权限范围和结论校验。
...
本工作流覆盖 Tip 27-30。这里先聚焦数据分析与 SQL，趋势分析和项目复盘方法可在附录 D 查阅。
...
30 个 Tip 是课后资料库，可作为后续查阅索引。建议优先参考“现场重点”“简短演示”和“课后可试”三类。
