...
> - v7.20 · 约 120 min · 产品经理 AI 应用交流分享
...
> 说明：Tip 地图用于建立顺序感，重点 Tip 用于现场展开，完整 Tip 和补充模板可在附录 B 按场景查阅。
...
这一节先建立一个共识：AI 输出质量很大程度取决于输入材料是否结构化。Tip 1-4 的完整模板保留在附录 B，便于课后直接复制。
...
| [LobeHub Skills](https://lobehub.com/zh/skills) | 参考不同场景下 Skill 的结构、描述方式和使用边界 |

这些资源本身不一定都能直接用于 Codex，但里面的模板、流程和检查清单，都可以整理成 Markdown，再变成 Codex Skill 或团队内部工作流模板。
...
3. 再看“简短带过”：Tip 27、28。
4. 遇到具体工作场景时，再到附录 B 里按工作流查完整 30 个 Tip。
