...
| 108–118 min | 真实案例 walkthrough | AI 商品视频系统从需求到原型到文档 |
...
现场仍然不会逐条讲完 30 个 Tip，而是围绕产品经理从模糊需求到可交付方案的主线，重点讲 7 个 Tip，并穿插现场演示和案例 walkthrough。其他 Tip 作为课后资料，大家可以根据自己的工作场景按需查阅。
...
| 使用方式 | 内容 | 现场重点 |
|---|---|---|
| 重点讲解 | Tip 5：让 AI 先反问关键问题 | 先澄清问题，再写方案 |
| 重点讲解 | Tip 6：需求信息完整度评分 | 判断需求是否足够进入 PRD 和评审 |
| 重点讲解 | Tip 7：MVP 范围收敛 | 帮助一期范围收敛到可落地 |
| 重点讲解 | Tip 9 / Tip 11：PRD 草稿 + 反向检查 | 快速成稿，再让 AI 补充问题和边界 |
| 重点讲解 | Tip 14：HTML 高保真原型 | 把抽象需求变成可点击、可讨论的界面 |
| 重点讲解 | Tip 22：需求变更影响分析 | 扫描“顺便改一下”背后的影响面 |
| 重点讲解 | Part 2：真实案例 Walkthrough | 串起从需求到原型到文档的完整流程 |
| 简短演示 | Tip 27 / Tip 28：数据分析与 SQL | 用较短时间演示自助分析和 SQL 辅助 |
| 课后阅读 | Part 4 Prompt 清单、附录 D 30 个 Tip 总览 | 作为课后参考和查阅资料 |
...
30 个 Tip 是课后资料库，不是现场逐条讲解清单。建议优先参考“现场重点”和“课后可试”两类。
...
| 27 | 让 AI 分析 CSV / Excel | 数据分析与复盘 | 课后可试 |
| 28 | 让 AI 辅助写 SQL | 数据分析与复盘 | 课后可试 |
