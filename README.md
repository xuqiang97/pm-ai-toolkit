...
| 课程定位 | 不讲空泛概念，重点分享产品经理日常工作中可直接复用的 AI 工作流 |
| 核心目标 | 让大家听完后，至少能在一个真实工作场景中马上用起来 |
| 课后产出 | 常用 Prompt 模板、AI 工作流清单、实战案例参考、持续交流机制 |
...
1. 业务方只给一句模糊诉求，不知道怎么快速拆清楚。
2. 会议纪要、聊天记录、业务反馈散落在各处，整理成本很高。
3. PRD 写得慢，异常场景、验收标准容易漏。
4. 页面需求光靠文字讲不清楚，业务方和研发理解不一致。
5. 需求范围越做越大，一期 MVP 很难收敛。
6. 业务方一句“顺便加一下”，实际可能影响页面、接口、权限、数据和测试。
7. 数据分析、SQL、指标口径经常要等别人排期。
8. 项目资料越积越多，过一段时间自己都忘了当初为什么这么设计。
9. AI 工具很多，但不知道产品经理到底该怎么用。

本次分享的核心不是教大家“玩 AI”，而是演示：

> **产品经理如何用 AI，把一个模糊业务问题，快速推进成可讨论、可评审、可开发、可复盘的产品方案。**
...
> **AI 不是替代产品经理做判断，而是帮助产品经理更快完成结构化分析、表达和交付。**
...
| 时间 | 模块 | 重点内容 |
|---:|---|---|
| 0–5 min | 开场：PM 为什么要用 AI | AI 对产品经理岗位的实际价值 |
| 5–13 min | 工作流一：接需求与资料整理 | 会议听记、多源文本转 MD、项目知识库 |
| 13–24 min | 工作流二：需求澄清与范围收敛 | AI 反问关键问题、完整度评分、MVP 砍范围 |
| 24–34 min | 工作流三：PRD 与评审准备 | PRD 草稿、反向 challenge、验收用例、评审材料 |
| 34–46 min | 工作流四：HTML 高保真原型 | 生成可点击原型、连续迭代、模拟用户预审、多对象文档 |
| 46–52 min | 工作流五：协同交付与上线 | 变更影响分析、研发任务拆解、测试清单、上线通知 |
| 52–56 min | 工作流六：数据分析与复盘 | CSV / Excel 分析、SQL 辅助、异常洞察、项目复盘 |
| 56–59 min | 真实案例 walkthrough | AI 商品视频系统从需求到原型到文档 |
| 59–60 min | 进阶展望与收尾 | Projects、Canvas、MCP、Codex / Claude Code、持续学习 |

> 现场时间如果比较紧，可以重点讲：需求澄清、MVP 收敛、HTML 原型、变更影响分析、真实案例。其他部分作为课后资料。

---

## 现场讲解说明

这份 README 整体同时承担两个用途：**60 分钟培训主线 + 课后 Prompt 资料库**。

现场不会逐条讲完 30 个 Tip，而是围绕产品经理从模糊需求到可交付方案的主线，重点讲 7 个核心 Tip。其他 Tip 作为课后资料，大家可以根据自己的工作场景按需查阅和练习。
...
| 使用方式 | 内容 | 现场重点 |
|---|---|---|
| 必讲 | Tip 5：让 AI 先反问关键问题 | 先澄清问题，再写方案 |
| 必讲 | Tip 6：需求信息完整度评分 | 判断需求是否足够进入 PRD 和评审 |
| 必讲 | Tip 7：MVP 砍范围神器 | 帮助一期范围收敛到可落地 |
| 必讲 | Tip 9 / Tip 11：PRD 草稿 + 反向 challenge | 快速成稿，再让 AI 挑刺补漏洞 |
| 必讲 | Tip 14：HTML 高保真原型 | 把抽象需求变成可点击、可讨论的界面 |
| 必讲 | Tip 22：需求变更影响分析 | 扫描“顺便改一下”背后的影响面 |
| 必讲 | Part 2：真实案例 Walkthrough | 串起从需求到原型到文档的完整流程 |
| 选讲 | Tip 27 / Tip 28：数据分析与 SQL | 时间允许时演示自助分析和 SQL 辅助 |
| 课后阅读 | Part 5 Prompt 清单、附录 D 30 个 Tip 总览 | 作为课后复制、练习和查阅资料 |

### 课后练习建议

第 1 天：用 Tip 5 练习“AI 反问关键问题”。  
第 2 天：用 Tip 7 练习“MVP 范围收敛”。  
第 3 天：用 Tip 9 / Tip 11 练习“PRD 草稿 + 反向 challenge”。  
第 4 天：用 Tip 14 练习“HTML 高保真原型”。  
第 5 天：用 Tip 22 练习“需求变更影响分析”。
...
| 层级 | 工具 | 适合场景 |
|---|---|---|
| 核心必学 | ChatGPT / Claude / Gemini 任选其一 | 需求拆解、文档生成、原型设计、数据分析 |
...
### Tip 5：让 AI 先反问关键问题，而不是直接写方案

#### 背景

很多人用 AI 的最大误区是：一上来就让 AI 直接写 PRD、直接画原型、直接写方案。这会导致 AI 脑补。

更专业的做法是：**先让 AI 反问你关键问题。**
...
AI 不只是帮我们加功能，更重要的是帮我们砍功能。普通人用 AI 是“帮我补全”，专业 PM 用 AI 是“帮我取舍”。
...
> 目标：让 AI 辅助产品经理写得更快、更完整，但最终判断仍由产品经理负责。
...
### Tip 11：让 AI 反向 challenge 你的 PRD

#### Prompt 模板

```text
你是一位非常严苛的资深产品经理，以挑刺出名。
...
关键技巧：建议先生成最严谨的开发说明，再基于开发说明生成其他对象文档。

原因是：开发说明对字段、状态、接口、异常要求最严格。先把底层逻辑讲清楚，其他文档更不容易互相矛盾。
...
> 如果现场时间允许，可以加一个 3 分钟小练习，让大家马上体验。
...
请不要直接写方案，而是先反向问我 10 个关键问题。

要求：
1. 问题覆盖业务目标、用户角色、数据来源、权限、指标、流程、异常、一期范围。
2. 每个问题后面说明为什么重要。
3. 按优先级排序。
```
...
看 AI 会问什么：主管是谁？看哪些团队？每天工作情况包括哪些指标？数据从哪里来？是否实时？是否支持下钻到个人？是否支持导出？是否有权限边界？看板的成功指标是什么？一期只做展示，还是支持任务分配和跟进？

### 练习目的

让大家理解：

> AI 的第一价值不是直接给答案，而是帮助产品经理把问题问完整。

---

# Part 4：进阶能力展望

> 前面讲的是大家可以马上用起来的基础工作流。  
...
AI 对产品经理最大的价值，不是替代我们思考，而是帮助我们更快完成这些工作：
...
```text
口语需求 → AI 生成 PRD 框架 → AI 挑刺 → AI 生成验收用例
```
...
今天分享的所有内容，本质上不是让大家记住某一个工具，而是建立一种新的工作方式：

> 当我们接到一个模糊需求时，不再从空白文档开始；  
> 当我们要确认范围时，不再只靠拍脑袋取舍；  
> 当我们要画页面时，不再只能停留在线框图；  
> 当我们要写 PRD 时，不再独自补全所有边界；  
> 当我们要做评审时，不再临时整理材料；  
> 当我们要做数据分析时，不再完全依赖别人排期；  
> 当我们做完一个项目时，也不再让经验散落在聊天记录里。

AI 不会直接让产品经理变强。

但会用 AI 的产品经理，可以更快地整理信息、验证想法、表达方案、发现问题、推动落地。
...
30 个 Tip 是课后资料库，不是现场逐条讲解清单。建议优先练习“现场必讲”和“课后练习”两类。

| 编号 | Tip | 所属工作流 | 建议使用方式 |
|---:|---|---|---|
| 1 | 会议沟通直接用 AI 听记 | 接需求与资料整理 | 资料库备用 |
| 2 | 多源文本统一转成 MD | 接需求与资料整理 | 课后练习 |
| 3 | 会后纪要升级成决策记录 | 接需求与资料整理 | 课后练习 |
| 4 | 把项目资料沉淀到知识库 | 接需求与资料整理 | 资料库备用 |
| 5 | 让 AI 先反问关键问题 | 需求澄清与范围收敛 | 现场必讲 |
| 6 | 需求信息完整度评分 | 需求澄清与范围收敛 | 现场必讲 |
| 7 | MVP 砍范围神器 | 需求澄清与范围收敛 | 现场必讲 |
| 8 | 一句话需求转完整需求分析框架 | 需求澄清与范围收敛 | 资料库备用 |
| 9 | 零散需求生成 PRD 草稿 | PRD 与评审准备 | 现场必讲 |
| 10 | few-shot 让 AI 学你的写作风格 | PRD 与评审准备 | 资料库备用 |
| 11 | 让 AI 反向 challenge 你的 PRD | PRD 与评审准备 | 现场必讲 |
| 12 | 自动生成验收用例 | PRD 与评审准备 | 课后练习 |
| 13 | 生成需求评审会材料 | PRD 与评审准备 | 课后练习 |
| 14 | 用 AI 直接生成 HTML 高保真原型 | HTML 高保真原型 | 现场必讲 |
| 15 | 用连续追问快速迭代原型 | HTML 高保真原型 | 资料库备用 |
| 16 | 截图反推需求说明 | HTML 高保真原型 | 资料库备用 |
| 17 | HTML 原型反向生成多对象文档 | HTML 高保真原型 | 课后练习 |
| 18 | 让 AI 模拟用户做可用性预审 | HTML 高保真原型 | 课后练习 |
| 19 | Persona Stack 多角色评审 | HTML 高保真原型 | 资料库备用 |
| 20 | Pre-mortem 失败预演 | HTML 高保真原型 | 资料库备用 |
| 21 | GitHub Pages 发布 HTML 原型 | HTML 高保真原型 | 资料库备用 |
| 22 | 需求变更影响分析 | 协同交付与上线 | 现场必讲 |
| 23 | PRD 转研发任务拆解 | 协同交付与上线 | 课后练习 |
| 24 | 生成测试同学最关心的问题 | 协同交付与上线 | 课后练习 |
| 25 | 上线公告 / 操作手册 / FAQ 一键生成 | 协同交付与上线 | 资料库备用 |
| 26 | 向上汇报一页纸 | 协同交付与上线 | 资料库备用 |
| 27 | 让 AI 分析 CSV / Excel | 数据分析与复盘 | 课后练习 |
| 28 | 让 AI 辅助写 SQL | 数据分析与复盘 | 课后练习 |
| 29 | 让 AI 从数据里找异常、趋势和机会 | 数据分析与复盘 | 资料库备用 |
| 30 | 项目复盘自动生成 | 数据分析与复盘 | 课后练习 |
